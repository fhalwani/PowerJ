...
class ViewStats extends JPanel {
	private static final long serialVersionUID = 967655000309765662L;
	private volatile boolean programmaticChange;
	private boolean[] selected, original;
	final String[] labels = {"Cases", "Specs", "Blks", "Slds", "H&E",
			"SS", "IHC", "Mol", "FSpec", "FBlk", "FSld", "Synop",
			"tatG", "tatH", "tatF", "tatT"};
	private final Timer selectionTimer;
	private ArrayList<JCheckBox> checkboxes = new ArrayList<JCheckBox>();

	ViewStats(boolean[] value, PowerJ parent) {
		super();
