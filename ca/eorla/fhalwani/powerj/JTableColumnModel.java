...
class JTableColumnModel extends DefaultTableColumnModel {
	private static final long serialVersionUID = 8323095514198420362L;
	...
	public void setColumnVisible(TableColumn column, boolean visible) {
		if (!visible) {
			...
			int visibleIndex = 0;
			for (int i = 0; i < noInvisibleColumns; ++i) {
