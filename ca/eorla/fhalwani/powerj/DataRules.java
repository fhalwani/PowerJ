...
class DataRules {
	...
	static final short RULE_CASE_BLOCKS_1_2_3PLUS = 104;
	static final short RULE_CASE_BLOCKS_1_2_X = 105;
	static final short RULE_CASE_FRAGS_X_MIN_MAX = 106;
	static final short RULE_CASE_FRAGS_1_2_3PLUS = 107;
	...
	static final short RULE_GROUP_1_2_3PLUS = 603;
	...
	static final short RULE_UNIQUE_1_2_3PLUS = 703;
	...
	static final short RULE_AFTER_1_2_3PLUS = 803;
	...
	static final short RULE_ADDL_1_2_3PLUS = 903;
	static final short RULE_ADDL_1_2_X = 904;

	static HashMap<Short, String> setMap(PowerJ parent) {
		ResultSet rst = parent.dbPowerJ.getRules();
		HashMap<Short, String> mapCodes = new HashMap<Short, String>();
		try {
			while (rst.next()) {
				mapCodes.put(rst.getShort("ID"), rst.getString("NAME"));
			}
		} catch (SQLException e) {
			parent.log(JOptionPane.ERROR_MESSAGE, "Rules", e);
		} finally {
