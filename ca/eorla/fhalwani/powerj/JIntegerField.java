...
class JIntegerField extends JTextField {
	private static final long serialVersionUID = 4388653239687274931L;
    ...
    JIntegerField(PowerJ parent, int min, int max) {
    	super();
    	...
    	setColumns(10);
    	String helpString = "(" + numbers.formatNumber(min) +
    ...
    public void setText(String str) {
    	setInt(numbers.parseInteger(str));
    }
    ...
    class IntVerifier extends InputVerifier implements ActionListener {
		...
		protected boolean checkField(JComponent input) {
			...
			try {
				...
				if (isValid) {
					newValue = numbers.parseInteger(txtValue);
