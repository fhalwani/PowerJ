...
public class JTreeTable extends JTable {
	private static final long serialVersionUID = 5533368482723232211L;
	/** A subclass of JTree. */
	protected TreeTableCellRenderer tree;
	private TreeTableModel treeTableModel;

	public JTreeTable(PowerJ parent, TreeTableModel treeTableModel) {
		super();
		...
		setDefaultRenderer(Double.class, new RendererDouble(parent, 2));
		// No grid
		setShowGrid(false);
	...
	public class TreeTableCellRenderer extends JTree implements TableCellRenderer {
		...
		public void updateUI() {
			...
			if (tcr instanceof DefaultTreeCellRenderer) {
				...
				dtcr.setBackgroundSelectionColor(Constants.COLOR_LIGHT_BLUE);
			}
		}
