...
class CboCases extends JComboBox {
	private static final long serialVersionUID = 943529040434013735L;
	private final DefaultComboBoxModel comboModel = new DefaultComboBoxModel();
	private final ViewCases colsView;
	private final JPopupMenu popupMenu = new JPopupMenu();

	CboCases(boolean[] value, PowerJ parent) {
		final int arrLength = value.length;
		final String[] cNames = {"DA", "DG", "DR", "DF", "FA", "SY", "SU", "PR", "SP", "ST", "NS", "NB", "NL", "HE",
				"SS", "IH", "MO", "FS", "FB", "FL", "SN", "GR", "HI", "RE", "TO"};
		...
		setMaximumSize(dim);
		colsView = new ViewCases(selected, parent);
				...
				javax.swing.SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						...
						if (popupShown) {
							...
							popupMenu.show(CboCases.this, 0, getHeight());
						}
					}
				});
			}
